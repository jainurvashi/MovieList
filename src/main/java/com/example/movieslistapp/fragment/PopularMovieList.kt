...
import com.example.movieslistapp.databinding.FragmentPopularMovieListBinding
...
import com.example.movieslistapp.viewModel.PopularMovieViewModel
...
class PopularMovieList : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPopularMovieListBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this, MyViewModelFactory(mainRepository)).get(PopularMovieViewModel::class.java)
        ...
        binding.recyclerview.addOnScrollListener(object : RecyclerView.OnScrollListener(){
            override fun onScrollStateChanged(recyclerView: RecyclerView, newState: Int) {
                if(!binding.recyclerview.canScrollVertically(1)){
                    viewModel.getAllPopularMovies(pageNumber++)
                }
            }
        })
